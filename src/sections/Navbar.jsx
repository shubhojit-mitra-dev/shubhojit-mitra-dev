      ...
      >
        ...
        >
          ...
          <div className="font-light">
            ...
            <div className="flex flex-wrap md:flex-row gap-x-2">
              {socials.map((social, index) => (
                <a
                  key={index}
                  href={social.href}
                  className="text-2xl md:text-3xl lg:text-4xl hover:text-white transition-colors duration-300"
                  target="_blank"
